...
import com.xxx.library.log.XxxLogKtxKt;
...
public class RealtimeBlurView extends View {
    ...
    protected boolean prepare() {//实时更新关键代码，可参考上面错误代码
        ...
        if (mBlurringBitmap == null) {//少了这个判断不出效果
            XxxLogKtxKt.log("mBlurringBitmap == null 1111");
        ...
        if (mBlurringBitmap == null) {
            XxxLogKtxKt.log("mBlurringBitmap == null 222");
            return false;
        }
        if (mBlurringCanvas==null) {
            XxxLogKtxKt.log("mBlurringCanvas == null  3333");
